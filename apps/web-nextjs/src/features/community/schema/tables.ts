...
import type { FileShow } from "@/features/upload/types";
import { joinMethod } from "@/features/community/schema/constants";
import { user } from "@/features/auth/schema/tables";
import { PermissionPresets } from "@/features/community/permissions";
...
export const communityMember = pgTable(
  "community_member",
  {
    ...
    // 加入方式/方法
    joinMethod: text("join_method", { enum: joinMethod })
      .default("discover")
